        ...
        {state.formats.length === 0 ? (
          ...
          <>
            <table className="w-full text-left border-collapse border border-inherit max-xs:text-sm">
              <thead>
                <tr>
                  <th className="table-cell text-lime-400 max-xs:text-xs">Opis</th>
                  <th className="table-cell text-lime-400 max-xs:text-xs">Wymiary</th>
                  <th className="table-cell text-lime-400 max-xs:text-xs">Ilość</th>
                </tr>
              </thead>
              <tbody>
                {state.formats.map((format, index) => (
                  <tr key={index} className="border border-lime-400 max-xs:text-xs">
